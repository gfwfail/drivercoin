...
uint256 hashGenesisBlock("0x8b2ddc4368ce1358554ed6f6a5c5adf815a7e1a3505bad6f9672cee229439bc0");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // DriveCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "DriveCoin Signed Message:\n";
...
{
    // DriveCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // DriveCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // DriveCoin: 3.5 days
static const int64 nTargetSpacing = 150; // DriveCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // DriveCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // DriveCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // DriveCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0d156437fadad5ac5299676e4b9dc3330b012e271ec7f0806e257fcdd6280b4a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0d5a63c595f850c0d95348780aad0ba55eb0d27457af6c8ce0e9d353a85aea3183763491fc5154b348672fba8d9286497a4fd58878b62a24f961f828856ea691dc") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515579454;
        block.nBits    = 504365644;
        block.nNonce   = 642587500;

        if (fTestNet)
        {
            block.nTime    = 1515579454;
            block.nNonce   = 3836467150;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xcd4c176eaadfd9b508077d010b37c82783c0698d257c78bd96c1f5647ae7a728"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // DriveCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DriveCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DriveCoinMiner : ProcessBlock, block not accepted");
    }
